...
export default function RightBar() {
  return (
    <div className={styles["rightbar"]}>
      ...
      {/* ── Sponsored Section (own scroll) ── */}
      <div className={styles["rightbar__section"]}>
        <p className={styles["rightbar__heading"]}>Sponsored</p>
        <div className={styles["rightbar__sponsored-scroll"]}>
      ...
      {/* ── Contacts Section (own scroll) ── */}
      <div className={`${styles["rightbar__section"]} ${styles["rightbar__section--contacts"]}`}>
        ...
        <div className={styles["rightbar__contacts-scroll"]}>
